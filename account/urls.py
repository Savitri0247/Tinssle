...
from account.views import SendPasswordResetEmailView, UserLoginWithEmailOtpView, EmailOtpVerifyView, UserChangePasswordView, UserLoginView, UserProfileView, UserRegistrationView, UserPasswordResetView, SocialLoginAPIView, UserLoginWithOtp, UserVerifyOtp
urlpatterns = [
